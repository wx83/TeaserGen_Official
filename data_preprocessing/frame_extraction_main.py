...
if __name__ == "__main__":
    video_name_list = utils.load_txt("/home/weihanx/videogpt/workspace/start_code/eval/final_eval.txt")
    input_dir = Path("/home/weihanx/videogpt/data_deepx/documentary/sliced_video")

    parent_dir = Path("/home/weihanx/videogpt/deepx_data7/frame_outputs_main_test_fpshalf")
    parent_dir.mkdir(parents=True, exist_ok=True)
    # video_name = "9ZxWTXoW_SM"
    for video_name in video_name_list:
        print(f"processing... = {video_name}")
        load_video = input_dir / video_name[0] / video_name / f"main.mp4"
