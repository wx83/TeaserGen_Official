...
parser.add_argument('--save_dir', type=str, default='/home/weihanx/videogpt/deepx_data6/gpt_demo/gpt_tf/feature')
...
def binary_search_threshold(text, video_name, input_dir, FPS, text_duration, last, last_last, min_duration,tolerance, min_threshold=-1, max_threshold=1.0, precision=0.001):
    """
...
# 0.000001
        best_duration, time_intervals = binary_search_threshold(text, video_name, input_dir, FPS, text_duration, last, last_last, min_duration, tolerance, min_threshold=-1, max_threshold=2,precision=0.000001)
        last_last = last
    ...
    output_json_path = output_dir / video_name[0] / video_name / f"time_interval_min_{min_duration}_{tolerance}.json"
    output_json_path.parent.mkdir(parents=True, exist_ok=True)
    save_json(output_json_path, clip_duration_dict)


if __name__ == "__main__":
    # min_duration, tolerance = 5,3
    # min_duration, tolerance = 5,1
    min_duration = 3
    tolerance = 0
    ...
    demo_save_folder = Path("/home/weihanx/videogpt/deepx_data6/gpt_demo/gpt_tf_1117")
